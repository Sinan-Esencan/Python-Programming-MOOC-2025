...
# First, write a function named get_station_data(filename: str). This function should read the names and locations of all the stations in the file, 
# and return them in a dictionary with the following format:
...
# }
# Dictionary keys are the names of the stations, and the value attached is a tuple containing the location coordinates of the station. The first element
# in the tuple is the Longitude field, and the second is the Latitude field.
...
# The distance is calculated using the Pythagorean theorem. The multiplication factors below are approximate values for converting latitudes and longitudes
# to distances in kilometres in the Helsinki region.
